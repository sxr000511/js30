...
<script>
// import { getGlobalData, clearGlobalData } from "../../utils/globalData.js";
...
export default {
  ...
  data: () => {
    return {
      ...
      username: this.$store.commit("getGlobalData", "username") || "", // 用户名，从 globalData 里取出
    };
  },
  components: {
    Menu,
  ...
  methods: {
    ...
    logout() {
      ...
      this.$store.commit("clearGlobalData", "username");
